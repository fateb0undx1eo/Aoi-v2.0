...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    if (!target) {
      return message.reply(`❌ Please mention someone to high five! Usage: \`${guildPrefix}highfive @user\``);
    }
    ...
    if (target.bot) {
      return message.reply("❌ You can't high five bots!");
    }
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        .setDescription(`${message.author} high fives ${target}`)
